        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16 gap-16 mb-8 md:mb-24">
          ...
          <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-x-8 gap-y-8">
            <div className="space-y-8">
              <span className="text-[14px] md:text-[10px] font-bold text-[#FBBB14] block [-webkit-text-stroke:1px_rgba(0,0,0,0.06)]" style={{ fontFamily: "'IhtishamDeshlipi', serif" }}>তথ্য</span>
            ...
            <div className="space-y-8">
              <span className="text-[14px] md:text-[10px] font-bold text-[#FBBB14] block [-webkit-text-stroke:1px_rgba(0,0,0,0.06)]" style={{ fontFamily: "'IhtishamDeshlipi', serif" }}>কেনুন</span>
              <ul className="space-y-3 text-[15px] md:text-[13px] font-medium text-black/60" style={{ fontFamily: "'KaiumSimanto', serif" }}>
            ...
            <div className="space-y-8">
              <span className="text-[14px] md:text-[10px] font-bold text-[#FBBB14] block [-webkit-text-stroke:1px_rgba(0,0,0,0.06)]" style={{ fontFamily: "'IhtishamDeshlipi', serif" }}>সহায়তা</span>
              <ul className="space-y-3 text-[15px] md:text-[13px] font-medium text-black/60" style={{ fontFamily: "'KaiumSimanto', serif" }}>
