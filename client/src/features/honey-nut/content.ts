...
export const importantNotes = ["এটি খাদ্যপণ্য; চিকিৎসার বিকল্প নয়।", "Nut allergy থাকলে গ্রহণ করবেন না।", "সুষম খাবার, পানি, বিশ্রাম ও নিয়মিত কার্যক্রমকে গুরুত্ব দিন।"] as const;
