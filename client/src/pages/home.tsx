    ...
    <Layout>
      ...
      <section className="w-full bg-[#f5f5f5] pb-2 pt-8 md:pb-3 md:pt-12">
        <div className="mx-auto max-w-[1500px] px-4 md:px-8 xl:px-12">
          ...
          >
            <h2 className="font-garet-book text-[clamp(1.7rem,4.5vw,2.7rem)] font-bold tracking-normal text-black">
              <span>Featured</span>{" "}
              <span
          ...
          <div className="relative mt-8 sm:mt-10">
            <motion.div
              ...
              ref={categoriesRef}
              className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto px-10 pb-2 sm:mx-auto sm:max-w-[820px] sm:grid sm:grid-cols-4 sm:gap-x-6 sm:gap-y-8 sm:overflow-visible sm:px-0 sm:pb-0"
            >
            ...
            <button
              ...
              className="absolute left-0 top-1/2 z-10 -translate-y-1/2 rounded-full border border-black/15 bg-white/90 p-2 text-black shadow-sm backdrop-blur-sm sm:hidden"
            >
            ...
            <button
              ...
              className="absolute right-0 top-1/2 z-10 -translate-y-1/2 rounded-full border border-black/15 bg-white/90 p-2 text-black shadow-sm backdrop-blur-sm sm:hidden"
            >
